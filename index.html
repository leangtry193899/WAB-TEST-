    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
      ...
      >
        <a href="index.html" class="logo d-flex align-items-center me-auto">
          ...
          <h1 class="sitename">EAST GROUP</h1>
            <img
                src="assets/img/EAST GROUP logo-01.png"
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="https://www.facebook.com/bslandhomecareer" target="_blank">Careers</a>
    ...
    <main class="main">
      ...
      <section id="hero" class="hero section dark-background">
        ...
        <div class="container d-flex flex-column align-items-center">
          <h2 data-aos="fade-up" data-aos-delay="100">WELCOM TO EAST GROUP </h2>
          <p data-aos="fade-up" data-aos-delay="200">
            East Group is a  prominent investment and development company in Cambodia, dedicated to building long-term value across multiple key sectors. With a strategic focus on real estate, finance, trading, industry, tourism, and agriculture, we aim to create integrated solutions that support the country's economic transformation. Our diversified portfolio reflects a commitment to sustainable growth, innovation, and responsible business practices. By investing in sectors vital to national development, East Group plays a key role in driving progress, generating employment, and contributing meaningfully to Cambodia’s future.
          </p>
          <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
            <a href="#about" class="btn-get-started">Get Started</a>
            <a
              href="
              https://youtu.be/xdEnMNDITP8?si=KE3pguDIcBhUDnu7
              "
        ...
        <div class="container">
          <div class="row gy-4">
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              />
              <p>
                Founded by Neak Oknha Ly Seng Kheang, EAST GROUP began its journey in the 1990s as a leader in Cambodia’s fashion industry. Since the early 2000s, we have expanded our operations into the real estate sector, where we have swiftly become one of the country’s foremost housing developers. Our portfolio includes large-scale projects that address strong market demand and contribute to Cambodia’s urban and economic development.
As a diversified investment and development group, EAST GROUP is dedicated to shaping Cambodia’s future through bold and strategic ventures spanning financial services, trading, infrastructure, tourism, and agriculture. 

              </p>
              <p>
                The name “EAST” signifies more than just a cardinal direction, it embodies the image of the rising sun, a powerful symbol of renewal and progress. This imagery captures the essence of our vision: a beacon of peace, prosperity, hope, and harmony.
These values are woven into every project we undertake, every partnership we cultivate, and every community we support. Guided by this philosophy, we remain steadfast in our commitment to fostering sustainable growth and delivering long-term value for all stakeholders.
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
              <div class="content ps-0 ps-lg-5">
                <p class="fst-italic">
                  <strong> Mission East Group </strong> is committed to building a resilient and prosperous Cambodia by: 
                </p>
                <ul>
                  <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span
                      >Investing strategically in real estate, financial services, trading, infrastructure, tourism, and agriculture</span
                    >
                  </li>
                  <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span
                      >Creating economic opportunities for local communities and global partners</span
                    >
                  </li>
                ...
                <p>
                  <strong> Vision </strong> To be a leading force in Cambodia’s sustainable transformation, driving inclusive growth, empowering communities, and creating long-term value through diversified investments across key economic sectors.
